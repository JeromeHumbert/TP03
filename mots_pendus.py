...
def tirer_mot()-> str:
    tab_mots = ['bleu', 'super', 'autre', 'bizarre', 'difficile', 'drole', 'etrange', 'facile', 'grave', 'impossible',
                ...
                'capitaine', 'chat', 'chemin', 'cheri', 'cheval', 'cheveu', 'chien', 'ciel', 'client', 'cœur', 'coin',
                ...
                'goût', 'gouvernement', 'grand', 'groupe', 'haut', 'homme', 'honneur', 'hotel', 'instant', 'interet',
                'interieur', 'jardin', 'jour', 'journal', 'lieu', 'long', 'maître', 'mari', 'mariage', 'matin',
                ...
                'aimer', 'ajouter', 'aller', 'amener', 'amuser', 'annoncer', 'apercevoir', 'apparaître', 'appeler',
                ...
                'dire', 'disparaître', 'donner', 'dormir', 'echapper', 'ecouter', 'ecrire', 'eloigner', 'embrasser',
                ...
                'foutre', 'frapper', 'gagner', 'garder', 'glisser', 'habiter', 'ignorer', 'imaginer', 'importer',
                'inquieter', 'installer', 'interesser', 'inviter', 'jeter', 'jouer', 'jurer', 'lâcher', 'laisser',
                'lancer', 'lever', 'lire', 'maintenir', 'manger', 'manquer', 'marcher', 'marier', 'mener', 'mentir',
                'mettre', 'monter', 'montrer', 'mourir', 'naître', 'obliger', 'occuper', 'offrir', 'oser', 'oublier',
                'ouvrir', 'paraître', 'parler', 'partir', 'passer', 'payer', 'penser', 'perdre', 'permettre', 'plaire',
                ...
                'recevoir', 'reconnaître', 'reflechir', 'refuser', 'regarder', 'rejoindre', 'remarquer', 'remettre',
                ...
                'traîner', 'traiter', 'travailler', 'traverser', 'tromper', 'trouver', 'tuer', 'utiliser', 'valoir',
